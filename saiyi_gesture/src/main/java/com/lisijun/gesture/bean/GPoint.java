package com.lisijun.gesture.bean;
...
public class GPoint {
    ...
    public GPoint(int leftX, int rightX, int topY, int bottomY,
    ...
    public void setPointState(int pointState) {
        ...
        switch (pointState) {
            case POINT_STATE_NORMAL:
                this.image.setBackgroundResource(R.mipmap.ic_gesture_dark);
                break;
            case POINT_STATE_SELECTED:
                this.image.setBackgroundResource(R.mipmap.ic_gesture_blue);
                break;
            case POINT_STATE_WRONG:
                this.image.setBackgroundResource(R.mipmap.ic_gesture_error);
                break;
            default:
                break;
        }
